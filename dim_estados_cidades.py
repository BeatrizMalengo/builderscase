...
if response.status_code == 200:
    ...
    for municipio in municipios_data:
        ...
        ufs.append(codigo_estado)
    
    # Criar o DataFrame de dimensão
    dim_cidades = pd.DataFrame({
    ...
    dim_cidades.to_csv('dim_cidades.csv', index=False)
    
    # Exibir o DataFrame
    print(dim_cidades.head())
else:
...
save_dataframe_to_gcs(dim_cidades, bucket_name, file_name, project_id, credentials_path)
